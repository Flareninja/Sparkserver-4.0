...
exports.Formats = [
    ...
    // SparkServer Exclusives
    ///////////////////////////////////////////////////////////////////

    {
        name: "LC Theorymon",
        section: "SparkServer Exclusives",
        column: 4,
    ...
    },
    {
        ...
        maxLevel: 5,           
        mod: 'creationism',
        ruleset: ['Pokemon', 'Standard', 'Team Preview', 'littlecupcreationism'],
        // Standard LC Bans as well as moveset reductions for Creationism go here
        // Ban Pokemon + move combinations as necessary.
        banlist: ['LC Uber', 'Gligar', 'Misdreavus', 'Scyther', 'Sneasel', 'Tangela', 'Dragon Rage', 'Sonic Boom', 'Swagger',
                  'Cryogonal + Sharpen', 'Cryogonal + Confuse Ray', 'Cryogonal + Explosion', 'Cryogonal + Hyper Beam',
                  'Cryogonal + Night Slash', 'Cryogonal + Poison Jab', 'Qwilfish + Swords Dance'
        ]
    ...
    ///////////////////////////////////////////////////////////////////
{
                name: "Smogon Doubles LC",
                section: "AEROW NERDXCLUSIVES",
                column: 4,
                
                searchShow: false,
                maxLevel: 5,
                gameType: 'doubles',
                ruleset: ['Pokemon', 'Species Clause', 'Moody Clause', 'OHKO Clause', 'Endless Battle Clause', 'Sleep Clause', 'HP Percentage Mod', 'Team Preview', 'Little Cup'],
                banlist: ['Unreleased', 'Illegal', 'Scyther', 'Sneasel', 'Tangela', 'Yanma']
        },
        {
                name: "Smogon Doubles LC [Suspect]",
                section: "AEROW NERDXCLUSIVES",
                
                maxLevel: 5,
                gameType: 'doubles',
                ruleset: ['Pokemon', 'Species Clause', 'Moody Clause', 'OHKO Clause', 'Endless Battle Clause', 'Sleep Clause', 'HP Percentage Mod', 'Team Preview', 'Little Cup'],
                banlist: ['Unreleased','Scyther', 'Sneasel', 'Tangela']
        },
        {
                name: "Smogon Triples LC",
                section: "AEROW NERDXCLUSIVES",
                
                maxLevel: 5,
                gameType: 'triples',
                ruleset: ['Pokemon', 'Species Clause', 'OHKO Clause', 'Moody Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Team Preview', 'Little Cup'],
		...
		maxLevel: 5,
		ruleset: ['Pokemon', 'Standard', 'Team Preview', 'Little Cup'],
		banlist: ['Dragon Rage', 'Sonic Boom'] // You allow Swagger but not D-rage or Sonic Boom wtf shit meta i wanna use scarf charmander
       },
       {
                name: "C-rank LC",
                section: "AEROW NERDXCLUSIVES",
                ...
                maxLevel: 5,
                ruleset: ['Pokemon', 'Standard', 'Team Preview', 'Little Cup'],
                banlist: ['Dragon Rage', 'Sonic Boom', 'Swagger', 'LC Uber', 'Gligar', 'Fletchling', 'Mienfoo', 'Pawniard', 'Abra', 
                        'Archen', 'Chinchou', 'Drilbur', 'Magnemite', 'Ponyta', 'Timburr', 'Tirtouga', 'Carvanha', 'Cottonee', 'Ferroseed', 
                        'Foongus', 'Porygon', 'Spritzee', 'Croagunk', 'Diglett', 'Gastly', 'Gothita', 'Omanyte', 'Snubbull', 'Vullaby', 
                        'Bunnelby', 'Dwebble', 'Munchlax', 'Scraggy', 'Trubbish', 'Vulpix', 'Zigzagoon', 'Corphish', 'Cranidos', 'Doduo', 
                        'Hippopotas', 'Houndour', 'Larvesta', 'Lickitung', 'Onix', 'Shellder', 'Staryu', 'Taillow', 'Bellsprout', 'Drifloon', 
                        'Elekid', 'Pumpkaboo', 'Riolu', 'Shellos', 'Slowpoke', 'Stunky', 'Torchic', 'Wynaut']
        },
        {
                name: "D-rank LC",
                section: "AEROW NERDXCLUSIVES",
                ...
                banlist: ['Dragon Rage', 'Sonic Boom', 'Swagger', 'LC Uber', 'Gligar', 'Fletchling', 'Mienfoo', 'Pawniard', 'Abra', 
                        ...
                        'Bunnelby', 'Dwebble', 'Munchlax', 'Scraggy', 'Trubbish', 'Vulpix', 'Zigzagoon', 'Corphish', 'Cranidos', 'Doduo', 
                        'Hippopotas', 'Houndour', 'Larvesta', 'Lickitung', 'Onix', 'Shellder', 'Staryu', 'Taillow', 'Bellsprout', 'Drifloon', 
                        'Elekid', 'Pumpkaboo', 'Riolu', 'Shellos', 'Slowpoke', 'Stunky', 'Torchic', 'Wynaut', 'Aipom', 'Amaura', 'Aron', 
                        'Binacle', 'Darumaka', 'Honedge', 'Koffing', 'Lileep', 'Magby', 'Spinarak', 'Surskit', 'Tentacool', 'Axew', 'Bulbasaur', 
                        'Chespin', 'Clamperl', 'Dratini', 'Frillish', 'Growlithe', 'Mantyke', 'Meowth', 'Pancham', 'Poliwag', 'Purrloin', 'Remoraid', 
                        'Sandshrew', 'Snover', 'Anorith', 'Buneary', 'Cacnea', 'Cubone', 'Froakie', 'Goldeen', 'Grimer', 'Inkay', 'Kabuto', 'Litleo', 
                        'Natu', 'Nosepass', 'Oddish', 'Shelmet', 'Teddiursa', 'Tyrunt', 'Wooper']
        },
        {      
                name: "E-rank LC",
                section: "AEROW NERDXCLUSIVES",
                ...
                banlist: ['Dragon Rage', 'Sonic Boom', 'Swagger', 'LC Uber', 'Gligar', 'Fletchling', 'Mienfoo', 'Pawniard', 'Abra', 
                        ...
                        'Chespin', 'Clamperl', 'Dratini', 'Frillish', 'Growlithe', 'Mantyke', 'Meowth', 'Pancham', 'Poliwag', 'Purrloin', 'Remoraid', 
                        'Sandshrew', 'Snover', 'Anorith', 'Buneary', 'Cacnea', 'Cubone', 'Froakie', 'Goldeen', 'Grimer', 'Inkay', 'Kabuto', 'Litleo', 
                        'Natu', 'Nosepass', 'Oddish', 'Shelmet', 'Teddiursa', 'Tyrunt', 'Wooper', 'Bronzor', 'Chikorita', 'Ekans', 'Fennekin', 
                        'Geodude', 'Golett', 'Goomy', 'Helioptile', 'Karrablast', 'Larvitar', 'Machop', 'Minccino', 'Numel', 'Paras', 'Phantump', 
                        'Pineco', 'Psyduck', 'Rufflet', 'Sewaddle', 'Shieldon', 'Shroomish', 'Skiddo', 'Skrelp', 'Slugma', 'Snivy', 'Solosis', 
                        'Starly', 'Trapinch', 'Venipede', 'Voltorb', 'Wailmer', 'Wingull', 'Zorua']
        },
        {      
                name: "LC Level 100",
                section: "AEROW NERDXCLUSIVES",
                ...
                maxLevel: 100,
                ruleset: ['Pokemon', 'Standard', 'Team Preview', 'Little Cup'],
                banlist: ['Swagger', 'LC Uber', 'Gligar']
        },
        {
                name: "LC 1v1",
                section: "AEROW NERDXCLUSIVES",
                ...
                banlist: ['LC Uber', 'Focus Sash', 'Sturdy + Berry Juice', 'Sonic Boom', 'Dragon Rage', 'Swagger'],
                validateTeam: function (team, format) {
                        if (team.length > 3) return ['You may only bring up to three Pokémon.'];
                },
                onBegin: function () {
        ...
        },
        {
                ...
                maxLevel: 5,
                ruleset: ['Pokemon', 'Standard', 'Baton Pass Clause', 'Swagger Clause', 'Same Type Clause', 'Team Preview', 'Little Cup'],
